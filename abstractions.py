...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # BEGIN Question 2
    # abstract this function as a dictionary (offers better clarity than a list of numbered indexes)
...
def restaurant_categories(restaurant):
    ...
    # BEGIN Question 2
    # call location list from restaurant variable passed as argument
...
def restaurant_ratings(restaurant):
    ...
    # BEGIN Question 2
    # 'reviews' is a list of lists with the 'name' and rating (1-5), we want only rating for each review
